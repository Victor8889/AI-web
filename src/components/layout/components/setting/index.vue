...
import { _changeSetting, _data, _getThemes } from './index.js'
import { vuexStore } from '@/store'
export default {

  props: defineProps(['visible']),

  setup(props) {
    function initEditData(id) {
      console.log('init edit data with id:', id)
    }
...
<template>
  <!-- 修改弹窗按钮点击事件 -->
  <!-- <Setting class="navbar-icon" :class="nightMode ? 'sun-mode' : 'night-mode'" @click="showDrawDia" /> -->

  <el-dialog title="项目配置" width="500px">
    <div class="draw-content">
      ...
      <div class="nav-row">
        ...
        >
          <div
            class="nav-item" :class="[`nav-item-${index}`, { active: navbarType === item }]"
